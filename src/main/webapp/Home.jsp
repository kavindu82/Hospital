...
@keyframes animate1
{
  0%
  {
    background-image: url(image/chenge_img/img1.jpg);
  }
  12.5%
  {
  ...
  100%
  {
    background-image: url(image/chenge_img/img8.jpg);
  }
}
...
<!------------Nav Bar----------------------------------------------------------------- -->
        ...
        <nav class="menu ">
            ...
            <ul>
                ...
                <li><a href="#"><img src="image/icon/home-page.png"/>  Home</a></li>
                <li><a href="#"><img src="image/icon/add-user-male.png"/>  Register</a></li>
                <li><a href="patientSign.jsp"><img src="image/icon/enter-2.png">  Login</a></li>
                <li><a href="#"><img src="image/icon/add-phone.png">  Contact Us</a></li>
                <li><a href="#"><img src="image/icon/service.png">  Services</a></li>
                <li><a href="emg.jsp"><img src="image/icon/user-male-circle.png">  Staff</a></li>
            </ul>
