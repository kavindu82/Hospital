...
.test{
    height:200px;
    width:230px;
	margin: 40px 10px 30px 180px;
	background: rgb(27,68,154);
   background: linear-gradient(90deg, rgba(27,68,154,0.711922268907563) 1%, rgba(27,68,154,0.865983893557423) 96%);
	color: #fff;
	border-radius:4px;
	transition: all 0.5s;
  cursor: pointer;
...
<div class="container ">
	  ...
	  <a href="#">
	  <button class="test"> <span>Phamarcist</span></button>
	  </a>
