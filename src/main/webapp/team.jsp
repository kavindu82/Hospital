...
<!------------Nav Bar-----------------------Css(61 -> 235 )------------------------------------------ -->
    ...
    <div class="login">
            <div class="account-login">
             <h1>Select Emergency Team</h1>
   <form action="DT" method="post" class="login-form">
   
      <div class="form-group">
                     <input type="text" name="vtype" placeholder="Enter Vehicle Type" class="form-control">
                  </div>
                  <div class="form-group">
                     <input type="text" name="dtype" placeholder="Enter Doctor Type NO"  class="form-control">
                  </div>
